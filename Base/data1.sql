...
('marie.dubois', '123456', 2, 2), -- motdepasse123
('pierre.martin', '123456', 2, 1),
('sophie.leroy', '123456', 2, 2);
...
(1, 10), (1, 13), (1, 16), (1, 14), (1, 17), -- Réponses correctes
(1, 11), (1, 15), (1, 18); -- Réponses aux questions générales
...
(2, 12), (2, 15), (2,18); -- Réponses aux questions générales
...
CHECK (
   (Id_question_generale IS NOT NULL AND Id_question IS NULL)
   OR
