...
<div class="d-flex" style="min-height: 100vh;">
    ...
    <nav class="bg-dark text-white p-3" style="width: 220px; min-height: 100vh;">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2"><a href="/Embauche" class="nav-link text-white">Embaucher</a></li>
            <li class="nav-item mb-2"><a href="/mes-entretiens" class="nav-link text-white">Mes entretiens</a></li>
        </ul>
    </nav>
    <!-- Main Content -->
