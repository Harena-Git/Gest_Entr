                            ...
                            <div class="info-card">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 text-primary">plus de ${profil.age} ans</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="info-card">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 text-primary">plus de ${profil.annee_experience} années</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <c:choose>
                                            <c:when test="${not empty profil.diplome}">
                                                <p class="mb-0 text-primary">minimum ${profil.diplome.niveau.libelle} en ${profil.diplome.filiere.libelle} </p>
